...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="midBlue" bgcolor="#FFFFFF">
      <tr>
        <td align="center"><a href="http://www.oncecode.com" target="_blank"><%=PwebVersion%></a> for <a href="http://<%=LocalHostUrl%>" style="color:blue; font:14px;"><%=LocalHostUrl%></a> by shemily</td>
      </tr>
      <tr><td>
